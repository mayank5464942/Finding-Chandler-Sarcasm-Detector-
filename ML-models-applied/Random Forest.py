# Finding Chandler_Random_Forest
...
classifier = RandomForestClassifier(n_estimators = 500, criterion = 'entropy', max_features = 'log2', random_state = 0, n_jobs = -1)
...
prediction = pd.DataFrame(answer, columns=['label']).to_csv('Output_NLP_Random_Forest.csv')
