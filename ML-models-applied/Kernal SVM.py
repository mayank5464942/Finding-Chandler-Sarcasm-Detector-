...
#Applying K-Fold Cros Validation 
...
parameters = [{'C': [1, 10, 100, 1000], 'kernal': [linear]},
               {'C': [1, 10, 100, 1000], 'kernal': [rbf], 'gamma': []}
        ]
...
prediction = pd.DataFrame(answer, columns=['label']).to_csv('Output_NLP_Kernal_SVM.csv')
